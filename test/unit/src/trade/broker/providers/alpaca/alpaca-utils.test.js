...
import { convertBuySellOrderToAlpacaRequest } from '../../../../../../../src/trade/broker/providers/alpaca/alpaca-utils';
...
describe('Alpaca Utils', () => {
    beforeEach(() => {
        jest.doMock('../../../../../../../src/trade/broker/providers/alpaca/alpaca.config.js', () => {
            return {
    ...
    test('getAlpacaHeaders() correctly populates the headers', async () => {
        ...
        alpaca = (await import('../../../../../../../src/trade/broker/providers/alpaca/alpaca'));
